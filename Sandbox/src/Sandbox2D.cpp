...
void Sandbox2D::OnUpdate(Mashenka::TimeStep ts)
{
    ...
    // Begin scene
    {
        ...
        Mashenka::Renderer2D::DrawRotatedQuad({ -1.0f, 0.0f }, { 0.8f, 0.8f }, 1.5f, { 0.8f, 0.2f, 0.3f, 1.0f });
        Mashenka::Renderer2D::DrawRotatedQuad({ 0.5f, -0.5f }, { 0.5f, 0.75f }, 0.0f, { 0.2f, 0.3f, 0.8f, 1.0f });
        Mashenka::Renderer2D::DrawRotatedQuad({ 0.0f, 0.0f, -0.1f }, { 10.0f, 10.0f }, 0.0f, m_CheckerboardTexture);
