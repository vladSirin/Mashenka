...
#define MK_INTERNAL_ASSERT_NO_MSG(type, check) MK_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", MK_STRINGIFY_MACRO(check), ::Mashenka::Assert::CurrentFileName(__FILE__), __LINE__)
